...
Clientes
	<div class="pull-right">
 		<a href="{URLLISTAR}" title="Listar Clientes" class="btn"> <span class="glyphicon glyphicon-list-alt"></span> Listar</a> 
 		<a href="{URLADICIONAR}" title="Adicionar Clientes" class="btn"><em class="icon-plus"></em><span class="glyphicon glyphicon-plus"></span> Adicionar</a>
	</div>
</legend>
